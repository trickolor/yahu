...
const variants = cva(
...

    {
        ...
        compoundVariants: [
            ...
            { variant: 'outline', color: 'secondary', class: 'border-secondary-surface text-secondary-surface hover:border-secondary-surface/85 hover:text-secondary-surface/85' },
            ...
            { variant: 'ghost', color: 'secondary', class: 'text-secondary-surface hover:bg-secondary-surface/10' },
            ...
            { variant: 'link', color: 'secondary', class: 'text-secondary-surface hover:text-secondary-surface/85' },
